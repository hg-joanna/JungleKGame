...
public class Piece {
     ...
     * @param trappedState determines whether the piece is trapped
     * @param beInWater determines whether the piece can be in water
     */
    public Piece(
        String name,
        int strength,
     ...
     *
     * @param row new row index of the piece
     * @param col new column index of the piece
     */
     ...
     *
     * @return false by default as only the rat piece can be in water
     */
     ...
     *
     * @return false by default as only lions and tigers can cross the lake
     */
    ...
    /**
     * Compares the piece to another piece to check if it is equal.
     *
